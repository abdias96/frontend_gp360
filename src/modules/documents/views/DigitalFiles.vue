    ...
    <div class="row g-5 mb-5">
      <div class="col-xl-3 col-md-6">
        <div class="card bg-primary hoverable card-xl-stretch mb-xl-8">
          <div class="card-body">
            <i class="ki-duotone ki-file text-white fs-2x mb-3">
              <span class="path1"></span>
              <span class="path2"></span>
            </i>
            <div class="text-white fw-bold fs-2">{{ statistics?.total_files || 0 }}</div>
            <div class="text-white fw-semibold fs-7">{{ $t('documents.digitalFiles.statistics.totalFiles') }}</div>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-warning hoverable card-xl-stretch mb-xl-8">
          <div class="card-body">
            <i class="ki-duotone ki-time text-white fs-2x mb-3">
              <span class="path1"></span>
              <span class="path2"></span>
            </i>
            <div class="text-white fw-bold fs-2">{{ statistics?.pending_verification || 0 }}</div>
            <div class="text-white fw-semibold fs-7">{{ $t('documents.digitalFiles.statistics.pendingVerification') }}</div>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-info hoverable card-xl-stretch mb-xl-8">
          <div class="card-body">
            <i class="ki-duotone ki-cloud-download text-white fs-2x mb-3">
              <span class="path1"></span>
              <span class="path2"></span>
            </i>
            <div class="text-white fw-bold fs-2">{{ statistics?.storage_usage?.total_size_mb || 0 }} MB</div>
            <div class="text-white fw-semibold fs-7">{{ $t('documents.digitalFiles.statistics.storageUsed') }}</div>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-danger hoverable card-xl-stretch mb-xl-8">
          <div class="card-body">
            <i class="ki-duotone ki-lock text-white fs-2x mb-3">
              <span class="path1"></span>
              <span class="path2"></span>
              <span class="path3"></span>
            </i>
            <div class="text-white fw-bold fs-2">{{ statistics?.confidential_files || 0 }}</div>
            <div class="text-white fw-semibold fs-7">{{ $t('documents.digitalFiles.statistics.confidentialFiles') }}</div>
          </div>
        </div>
      </div>
    </div>
...
import type { DigitalFile, FileStatistics, FileQueryParams, VerificationStatus } from '@/types/documents';
...
// Filters
const filters = reactive<FileQueryParams>({
  file_type: undefined,
...
const loadStatistics = async () => {
  try {
    const response = await DigitalFileService.getStatistics();
    if (response.success) {
