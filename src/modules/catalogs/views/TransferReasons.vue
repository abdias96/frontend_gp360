<template>
  <div>
    ...
    <CatalogList
      catalog-name="Motivo de Traslado"
      :items="items"
      :loading="loading"
...
const modalFields: ModalField[] = [
  {
    ...
    type: "text",
    required: true,
    placeholder: "Ingrese el nombre del motivo de traslado",
  },
  {
    key: "code",
    label: "Código",
...
const createItem = async (formData: any) => {
  try {
    ...
    console.error("Error creating transfer reason:", error);
  }
};
...
const editItem = async (id: number, formData: any) => {
  try {
    ...
    console.error("Error updating transfer reason:", error);
  }
};
...
const deleteItem = async (id: number) => {
  try {
    ...
    console.error("Error deleting transfer reason:", error);
  }
};
