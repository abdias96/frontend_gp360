...
const modalFields: ModalField[] = [
  {
    ...
    type: "text",
    required: true,
    placeholder: "Ingrese el nombre del tipo de visita",
  },
  {
    key: "code",
    label: "Código",
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    placeholder: "Descripción del tipo de visita",
  },
  {
    key: "active",
    label: "Activo",
...
const deleteItem = async (id: number) => {
  try {
    const response = await ApiService.delete(`/catalogs/visit-types/${id}`);
