<template>
  <div>
    ...
    <CatalogList
      catalog-name="Enfermedad Crónica"
      :items="items"
      :loading="loading"
...
const modalFields: ModalField[] = [
  {
    ...
    type: "text",
    required: true,
    placeholder: "Ingrese el nombre de la enfermedad crónica",
  },
  {
    key: "code",
    label: "Código",
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    placeholder: "Descripción de la enfermedad crónica",
  },
  {
    key: "active",
    label: "Activo",
