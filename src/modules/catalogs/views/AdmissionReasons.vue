<template>
  <div>
    ...
    <CatalogList
      catalog-name="Motivo de Ingreso"
      :items="items"
      :loading="loading"
...
const modalFields: ModalField[] = [
  {
    ...
    type: "text",
    required: true,
    placeholder: "Ingrese el nombre del motivo de ingreso",
  },
  {
    key: "code",
    label: "Código",
    type: "text",
    required: true,
    placeholder: "Código único del motivo de ingreso",
  },
  {
    key: "description",
    label: "Descripción",
...
const createItem = async (formData: any) => {
  try {
    ...
    console.error("Error creating admission reason:", error);
  }
};
...
const editItem = async (id: number, formData: any) => {
  try {
    ...
    console.error("Error updating admission reason:", error);
  }
};
...
const deleteItem = async (id: number) => {
  try {
    ...
    console.error("Error deleting admission reason:", error);
  }
};
