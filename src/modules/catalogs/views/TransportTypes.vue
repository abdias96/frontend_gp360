<template>
  <div>
    ...
    <CatalogList
      catalog-name="Tipo de Transporte"
      :items="items"
      :loading="loading"
...
const modalFields: ModalField[] = [
  {
    ...
    type: "text",
    required: true,
    placeholder: "Ingrese el nombre del tipo de transporte",
  },
  {
    key: "code",
    label: "Código",
    type: "text",
    required: true,
    placeholder: "Código único del tipo de transporte",
  },
  {
    key: "description",
    label: "Descripción",
    type: "textarea",
    required: false,
    placeholder: "Descripción del tipo de transporte",
  },
  {
    key: "active",
    label: "Activo",
